        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                ...
                <div class="flex justify-start lg:w-0 lg:flex-1">
                    <a href="#">
                        <span class="sr-only">C&F Fabricators</span>
                    ...
                    <div class="mt-6">
                        <nav class="grid gap-y-8">
                            ...
                            <a href="#" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                ...
                                <span class="ml-3 text-base font-medium text-gray-900"> Gallery </span>
                            </a>
                            ...
                            <a href="#" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                                ...
                                <span class="ml-3 text-base font-medium text-gray-900"> Service </span>
                            </a>
        ...
        <div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
            <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
                <h1
                    ...
                    <span class="block xl:inline">C&F Fabricators</span>
                    <span class="block text-orange-600 xl:inline">Sheet Metal Experts </span>
                </h1>
